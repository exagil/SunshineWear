...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        PutDataMapRequest weatherUpdateDataMapRequest = PutDataMapRequest.create("/blabla");
        DataMap weatherUpdateRequestDataMap = weatherUpdateDataMapRequest.getDataMap();
        weatherUpdateRequestDataMap.putLong("time", System.currentTimeMillis());
        PutDataRequest weatherUpdateRequest = weatherUpdateDataMapRequest.asPutDataRequest();
        weatherUpdateRequest.setUrgent();
        Wearable.DataApi.putDataItem(googleApiClient, weatherUpdateRequest);
        String weatherUpdateRequestUriString = weatherUpdateRequest.getUri().toString();
    }
